...
namespace Practice.Services.Interfaces
{
    public interface IMappingService
    {
        ...
        void MapToEntity(SessionDto dto, Session entity); // New overload for updating existing entity

        // Song mappings
        SongDto MapToDto(Song entity);
        Song MapToEntity(SongDto dto);
        void MapToEntity(SongDto dto, Song entity); // New overload for updating existing entity
